...
def create_cluster_layout(df, min_year, max_year, summary_data):
    ...
    """
    custom_style = {"mark": {"transition": "color 0.3s ease", "cursor": "pointer"}}
    ...
    description_modal = dbc.Modal(
        [
            ...
            dbc.ModalFooter(
                dbc.Button(
                    "Close", id="close-modal-cluster", className="ms-auto", n_clicks=0
                )
            ),
        ],
        ...
        [
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            "Unique Entities", className="card-title"
                                        ),
                                        html.P(
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            "Unique Vendors", className="card-title"
                                        ),
                                        html.P(
                                            f"{total_vendors:,} vendors",
                                            className="card-text",
                                        ),
                                    ]
                                )
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            "Awarded Amount", className="card-title"
                                        ),
                                        html.P(
                                            [
                            ...
                            [
                                dbc.CardBody(
                                    [
                                        ...
                                        html.P(
                                            f"Range: {min_awarded_year} - {max_awarded_year}",
                                            className="card-text",
                                        ),
                                    ]
                                )
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.H4(
                            "How Has the Average Yearly Tender Allocation Evolved Across Different Organizations in Nova Scotia?"
                        ),
                        width=12,
                    ),
                    dbc.Col(
                        dcc.Loading(
                            ...
                            type="circle",
                            children=[dcc.Graph(id="entity-year-average-amount")],
                        ),
                        width=12,
                    ),
                    dbc.Col(
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.H4(
                            "How Do Organization Clusters in Nova Scotia Show Different Spending Patterns Over Time (by Year)?"
                        ),
                        width=12,
                    ),
                    dbc.Col(
                        dcc.Loading(
                            ...
                            type="circle",
                            children=[dcc.Graph(id="cluster-year-average-amount")],
                        ),
                        width=12,
                    ),
                    dbc.Col(
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.H4(
                            "Which clusters have contributed the most to cumulative tender amounts over the years in Nova Scotia?"
                        ),
                        width=12,
                    ),
                    dbc.Col(
                        dcc.Loading(
                            ...
                            type="circle",
                            children=[dcc.Graph(id="cluster-year-cumulative-amount")],
                        ),
                        width=12,
                    ),
                    dbc.Col(
    ...
    main_content = dbc.Col(
        [
            ...
            dcc.Loading(
                ...
                type="circle",
                children=[dcc.Graph(id="tender-frequency-count-cluster")],
            ),
            ...
            dcc.Loading(
                ...
                type="circle",
                children=[dcc.Graph(id="awarded-amount-vs-vendor-cluster")],
            ),
            ...
            dcc.Loading(
                ...
                children=[
                    dcc.Graph(
                        id="topic-word-cloud-cluster", config={"displayModeBar": False}
                    )
                ],
            ),
            ...
            dcc.Loading(
                ...
                children=[
                    dcc.Graph(
                        id="topic-time-visualization-cluster",
            ...
            dcc.Loading(
                ...
                children=[
                    dcc.Graph(
                        id="year-vs-awarded-amount-cluster",
    ...
    return dbc.Container(
        [dbc.Row([sidebar_content, main_content]), description_modal],
        fluid=False,
        style={"padding": "0"},
    )
