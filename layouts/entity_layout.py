    ...
    main_content = dbc.Col(
        [
            ...
            dcc.Loading(
                ...
                type="circle",
                children=[dcc.Graph(id="tender-frequency-count")],
            ),
            ...
            dcc.Loading(
                ...
                type="circle",
                children=[dcc.Graph(id="awarded-amount-vs-vendor")],
            ),
            ...
            dcc.Loading(
                ...
                children=[
                    dcc.Graph(
                        id="topic-time-visualization", config={"displayModeBar": False}
                    )
                ],
            ),
            ...
            dcc.Loading(
                ...
                children=[
                    dcc.Graph(
                        id="year-vs-awarded-amount", config={"displayModeBar": True}
                    )
                ],
            ),
